...
(define-abbrev-table 'latex-mode-abbrev-table
  '(
    ...
    ("bpr" "" latex-skel-proposition 0)
    ("bprf" "\\begin{proof} " nil 0)
...
(define-abbrev-table 'text-mode-abbrev-table
  '(
    ("LIV" "Buongiorno,
Vorrei che venissero abilitati all'utilizzo del LIV gli studenti:
